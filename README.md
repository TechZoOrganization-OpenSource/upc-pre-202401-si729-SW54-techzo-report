...
<br><div align="center"><h3>Junio 2024</h3></div><br>
...
<table >
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="3" align = "justify">
      <h3>Diego Anderson Criollo De La Cruz</h3><b>TB1</b><p>Mantuve una comunicación transparente con cada miembro de mi equipo a través de grupos de mensajería, asegurándome de compartir mis ideas en cada reunión. Además, contribuí activamente al desarrollo colaborativo de la landing page de la aplicación web.</p><b>TP1</b><p>Durante el desarrollo de esta segunda entrega, considero que he logrado el student outcome, ya que mantuve una consistente comunicación por chat con todos mis compañeros del equipo y cumplí con todas mis partes asignadas, las cuales las notifiqué al equipo, por chat, cada vez que terminaba alguna de estas.</p> <b>TB2</b><p>Al reflexionar sobre este entregable, estoy convencido de haber cumplido plenamente con el student outcome, debido a que cuando surgieron conflictos de merge en nuestro repositorio Git, organicé sesiones de pair programming para resolverlos, aprovechando para compartir conocimientos sobre estrategias de resolución de conflictos y buenas prácticas de Git. Mi enfoque proactivo no se limitó a lo técnico; también propuse mejoras en nuestro proceso de Scrum, como introducir la técnica de Planning Poker para estimar esfuerzos de manera más precisa.</p> </p><b>TF1</b><p>Al concluir este ciclo, estoy convencido de haber cumplido plenamente con los objetivos del curso gracias a la colaboración efectiva a lo largo del proyecto. Cuando surgieron conflictos de merge en nuestro repositorio Git, organicé sesiones de pair programming para resolverlos, lo que no solo abordó los problemas técnicos, sino que también fortaleció nuestro trabajo en equipo. Superar estos desafíos me enseñó valiosas lecciones sobre la importancia de la colaboración y la comunicación continua. Mi enfoque proactivo se extendió más allá de lo técnico, proponiendo mejoras en nuestro proceso de Scrum, lo que promovió un entorno de trabajo más cohesivo y eficiente. Estas experiencias no solo garantizaron el éxito del proyecto, sino que también enriquecieron mi comprensión del trabajo en equipo y la gestión de proyectos.</p>
      <h3>Joseph Alexis Huamani Mandujano</h3><b>TB1</b><p>Promoví una comunicación clara con cada integrante de nuestro equipo cada vez que me comuniqué con ellos por chat, garantizando que mis conceptos se transmitieran correctamente en cada encuentro para garantizar la calidad de nuestra propuesta.</p><b>TP1</b><p>En esta segunda entrega, creo firmemente que he alcanzado el student outcome al mantener una comunicación constante por chat con todos mis colegas del equipo y siempre estar en contacto con cada uno de ellos.</p><b>TB2</b><p>Al culminar este entregable, considero que he logrado satisfactoriamente el student outcome, debido a que, durante todo el proyecto, he mantenido una comunicación clara, activa y concisa en todo momento con todos los miembros del equipo, siempre aportando dando ideas de solución y tratando de apoyarlos ante cualquier duda que tengan.</p><b>TF1<b><p>Al finalizar este ciclo, estoy seguro de haber cumplido con los objetivos del curso gracias a una colaboración efectiva en el proyecto. Cuando surgieron conflictos de merge en nuestro repositorio Git, implementé sesiones de pair programming para resolverlos, lo cual no solo solucionó los problemas técnicos, sino que también fortaleció la cohesión del equipo. Utilizamos la metodología Gitflow, gestionando ramas específicas para cada user story, lo que facilitó una integración continua y organizada. Siguiendo la metodología Scrum, dividimos las user stories en sprints, asegurando un enfoque sistemático y estructurado para cada etapa del proyecto. Mi enfoque proactivo incluyó sugerencias para optimizar nuestros procesos de Scrum, promoviendo un entorno de trabajo más eficiente y coordinado. Estas experiencias no solo garantizaron el éxito del proyecto, sino que también ampliaron mi comprensión sobre el trabajo en equipo y la gestión de proyectos. A través de estos desafíos, aprendí valiosas lecciones sobre la importancia de la colaboración y la comunicación continua, lo que me permitió comunicar de manera clara y objetiva ideas y resultados a audiencias de diferentes especialidades y niveles jerárquicos.</p>
      <h3>Mathias André Mendoza Carrión</h3><b>TB1</b><p>Fomenté una comunicación continua con cada uno de los miembros de nuestro equipo, asegurándome de transmitir mis ideas en cada encuentro para asegurar la originalidad y la excelencia de nuestra solución propuesta. </p> <b>TP1</b><p>En el proceso de esta segunda fase, estoy seguro que he cumplido con el student outcome, puesto que mantuve una comunicación regular por chat con todos mis compañeros de equipo.</p> <b>TB2</b><p>Al finalizar este entregable, considero que he alcanzado exitosamente el student outcome. A lo largo del proyecto, me aseguré de mantener una comunicación abierta y constante con todos los miembros del equipo, siempre proponiendo soluciones a los problemas y ofreciendo apoyo a mis compañeros cuando lo necesitaban.</p><b>TF1<b><p>Al finalizar este ciclo, tengo plena confianza en haber cumplido exitosamente con los objetivos del curso y los míos propios, gracias a una colaboración constante. Ante los desafíos de fusión en nuestro repositorio Git, trabajamos en equipo para resolverlos, lo cual no solo solucionó los problemas técnicos, sino que también fortaleció nuestra dinámica de equipo. Además de mi enfoque proactivo en los aspectos técnicos, propuse mejoras para nuestro proceso de Scrum, contribuyendo así a un ambiente de trabajo más cohesionado y eficiente. Estas experiencias no solo garantizaron el éxito del proyecto, sino que también enriquecieron mi comprensión sobre la colaboración en equipo.</p>
      <h3>Ian Haziel Donato Santisteban Palomino</h3><b>TB1</b><p>Como líder del equipo, estuve siempre en contacto con cada uno de los miembros del grupo, resolviendo sus dudas por chat y verificando que vayan avanzando correctamente con el trabajo.</p><b>TP1</b><p>Considero que, como líder del equipo, sí he logrado cumplir completamente el student outcome, esto porque todos los días estuve en comunicación por chat personal y del equipo con cada miembro del equipo y les ayudé en todas las preguntas que me hicieron.</p> <b>TB2</b><p>Al finalizar esta entrega, puedo afirmar que he logrado satisfactoriamente el student outcome relacionado con la comunicación efectiva. Durante todo el sprint 3 , mantuve una comunicación clara, activa y concisa con todos los miembros del equipo. Siempre aporté ideas de solución y brindé apoyo ante cualquier duda que surgiera. La comunicación escrita fue fundamental para transmitir de manera objetiva mis ideas y resultados.</p><b>TF1<b><p>Con el ciclo finalizando, puedo afirmar que hemos cumplido satisfactoriamente con todos los objetivos del curso. Hemos mejorado nuestras habilidades de comunicación y expresión de ideas de forma oral y escrita. Esto se ha logrado apoyándonos mutuamente para alcanzar nuestro objetivo de completar satisfactoriamente todo lo planeado inicialmente. Esta experiencia ha sido invaluable para mejorar nuestra forma de trabajar en equipo y gestionar proyectos de distintos ámbitos.</p>
      <h3>Abel Andrés Valle Zuta</h3><b>TB1</b><p>Tuve una comunicación clara, consisa y precisa cada vez que mandé mensajes por chat, haciéndoles saber qué puntos faltaban realizar, coordinar la hora en la que nos íbamos a reunir y comunicales los puntos en los que considero mejor me desempeño para aportar y tener un buen desempeño realizando el proyecto.</p><b>TP1</b><p>Al terminar este trabajo parcial, considero que he cumplido satisfactoriamente el student outcome, debido a que, durante todo el proyecto, mantuve una comunicación activa en todo momento vía chat personal y grupal con todos los miembros del equipo, siempre tratando de apoyarlos y de resolver cualquier duda que tengan, además de haberles pedido ayuda en caso fuese necesario.</p><b>TB2</b><p>En este tercer entregable, considero que he continuado cumpliendo con el student outcome, debido a que en todo momento he tenido una comunicación activa, clara, precisa y con la intención de apoyar a cada miembro de mi equipo, tanto de forma oral como escrita siempre he buscado ayudarlos en todo lo posible, lo cuál ha hecho que nos unamos cada vez más como grupo y de este modo lograr tener un resultado satisfactorio y eficiente.</p><b>TF1<b><p>Ahora que el presente ciclo está finalizando, puedo decir que he logrado cumplir satisfactoriamente con todos los objetivos del curso, ya que además de aprender nuevos conceptos y tecnologías, también he logrado desarrollar aún más mi habilidad de comunicarme y expresar mis ideas tanto de forma oral como escrita, ya que estuve en contacto via chat, llamadas, y reuniones presenciales con todos los miembros del equipo, apoyándonos en todo momento con el fin de lograr nuestro objetivo, lograr completar satisfactoriamente todo lo proyectado desde el inicio del ciclo. Toda esta gran experiencia, me ayudó a mejorar mi forma de trabajar en equipo y también la de gestionar diferentes tipos de proyectos.</p> </td>
      <td colspan="3"><b>TB1</b> <p>Nuestra comunicación escrita fue un pilar fundamental de nuestro éxito. Mantuvimos una conversación constante a través de diversos medios, lo que nos permitió estar al tanto del progreso del proyecto en todo momento. Organizamos reuniones periódicas para sincronizar nuestros esfuerzos y asegurarnos de que estábamos en el mismo camino. Sin embargo, incluso cuando no podíamos reunirnos en tiempo real, nuestra comunicación escrita resultó efectiva para resolver cualquier duda o inquietud que surgiera. Esta capacidad para mantener una comunicación clara y efectiva, tanto de forma sincrónica como asíncrona, fue esencial para mantenernos en el camino correcto y garantizar el éxito de nuestro proyecto.</p><b>TP1</b><p>durante esta segunda fase del proyecto, hemos demostrado nuestra capacidad para mantener una comunicación fluida y constante a través del chat, lo cual ha sido fundamental para alcanzar con éxito el outcome deseado. Esta práctica ha sido evidente a lo largo de todo el proceso, permitiéndonos mantener un diálogo regular entre todos los miembros del equipo, asegurando así que cada uno esté al tanto de las tareas asignadas y de los avances realizados. Esta dedicación a la comunicación ha fortalecido nuestra colaboración y ha contribuido significativamente a mantener un ambiente de trabajo productivo y armonioso. Además, ha permitido resolver rápidamente cualquier inconveniente que haya surgido, garantizando así el cumplimiento de los objetivos establecidos. En resumen, nuestra capacidad para mantener una comunicación efectiva ha sido clave para el éxito de esta etapa del proyecto.</p><b>TB2</b><p>Hemos demostrado tener una habilidad destacada para comunicar de manera efectiva nuestras ideas y resultados por escrito en el contexto del desarrollo de proyectos de ingeniería. Además, hemos mantenido una comunicación activa, clara y concisa con todos los miembros del equipo, proporcionando apoyo y soluciones a lo largo de todo el proceso. Además, mostramos un enfoque proactivo al proponer mejoras en los procesos y compartir conocimientos para resolver desafíos técnicos, lo que refleja nuestro compromiso con el éxito del proyecto y nuestra capacidad para comunicarnos objetivamente con audiencias de diferentes especialidades y niveles jerárquicos, por lo que consideramos haber cumplido satisfactoriamente con el student outcome.</p><b>TF1<b><p>Al finalizar este ciclo, podemos afirmar con confianza que hemos cumplido plenamente con los objetivos del curso y, específicamente, con el student outcome relacionado con la comunicación escrita. A lo largo del desarrollo del proyecto en ingeniería, no solo hemos aprendido nuevos conceptos y tecnologías, sino que también hemos mejorado significativamente nuestra habilidad para comunicar ideas y resultados de manera objetiva a audiencias de diferentes especialidades y niveles jerárquicos. Nuestra interacción constante vía chat, llamadas y reuniones presenciales han sido fundamentales para mantenernos informados y apoyarnos mutuamente en todo momento. Este enfoque de comunicación continua nos permitió resolver conflictos técnicos mediante sesiones de programadas. Estas experiencias fortalecieron nuestro trabajo en equipo y nos enseñaron valiosas lecciones sobre la importancia de la colaboración. Estas iniciativas no solo contribuyeron al éxito del proyecto, asegurando una funcionalidad completa y una experiencia de usuario fluida, sino que también enriquecieron nuestra comprensión del trabajo en equipo y la gestión de proyectos. En resumen, esta experiencia ha sido invaluable para mejorar nuestras habilidades de comunicación y gestión, cumpliendo con creces el student outcome y los objetivos del curso.</p></td>
    </tr>
  </tbody>
</table>
...
|**US-23**|Acceder al centro de soporte para resolver cualquier problema técnico que se presente.|**Como** usuario de CambiaZo, **quiero** tener la opción de acceder a un centro de soporte **para** reportar y resolver mis problemas técnicos.|<p>**Escenario 1:** Acceso a configuración</p><p>**Dado que** me encuentro en la pestaña principal de CambiaZo</p><p>**Cuando** me desplace hacia el footer de la página</p><p>**Entonces** se mostrará el apartado de configuración con sus opciones disponibles.</p><p></p><p>**Escenario 2:** Ingresar al “Centro de ayuda”</p><p>**Dado que** me encuentro en el footer de la página</p><p>**Cuando** le de click a la opción “Ayuda”</p><p>**Entonces** seré redirigido al centro de ayuda.</p><p></p><p>**Escenario 3:** Problemas técnicos</p><p>**Dado que** me encuentro en la sección de “Ayuda”</p><p>**Cuando** le de click en “Problemas técnicos”</p><p>**Entonces** se mostrará una lista con los problemas técnicos más frecuentes y sus soluciones.**</p><p></p><p>**Escenario 4:** Chatear con soporte</p><p>**Dado que** me encuentro en la sección de “Ayuda”</p><p>**Cuando** le de click en “Chatear con soporte”</p><p>**Entonces** se mostrará un formulario en el cual podemos enviar nuestro problema para chatear con soporte.</p>|**EP05**|
...
|**TS13**|Create API Product|<p>**Como** usuario developer que configura la plataforma</p><p>**Quiero** diseñar una API que facilite la gestión de productos</p><p>**Para** que los usuarios puedan subir sus productos que ya no utilizan</p>|<p>**Escenario 1: Diseño de la API de Productos**</p><p>Dado que el usuario developer está configurando la plataforma,</p><p>Cuando diseña la API de Productos para gestionar los objetos que suben los usuarios,</p><p>Entonces define los endpoints y rutas necesarios para permitir a los usuarios subir sus objetos que ya no usan, cancelar la subida y obtener información sobre sus productos y establecen los requisitos de requerimiento y tipo de archivo.</p>|**EP07**|
|**TS14**|Get Product|<p>**Como** usuario developer de la aplicación Cambiazo,</p><p>**Quiero** poder obtener información sobre los productos existentes en la plataforma a través del API,</p><p>**Para** mostrar esta información a los usuarios y permitirles ver la información completa de los objetos que hay.</p>|<p>**Escenario 1: Obtener información de productos**</p><p>Dado que el endpoint "/products" está disponible,</p><p>Cuando se envía una solicitud GET con el identificador del objeto,</p><p>Entonces se recibe una respuesta con estado 200,</p><p>Y se obtienen los detalles del producto solicitado.</p><p>**Escenario 2: Producto no encontrado**</p><p>Dado que el endpoint "/products" está disponible,</p><p>Cuando se envía una solicitud GET con un identificador de un objeto que no existe,</p><p>Entonces se recibe una respuesta con estado 404,</p><p>Y se muestra un mensaje que indica "No se encontró el objeto solicitado".</p>|**EP07**|
|**TS15**|Post Product|<p>**Como** usuario developer de la aplicación Cambiazo,</p><p>**Quiero** implementar una API que permita a los usuarios publicar sus productos,</p><p>**Para** que puedan subir sus objetos que ya no utilizan y desean intercambiar.</p>|<p>**Escenario 1: Creación de un nuevo producto**</p><p>Dado que el endpoint "/products" está disponible,</p><p>Cuando se envía una solicitud POST con los detalles de los productos y el usuario asociado,</p><p>Entonces se recibe una respuesta con estado 201,</p><p>Y se registra el producto con un nuevo ID y los detalles registrados.</p><p>**Escenario 2: Producto ya existente**</p><p>Dado que el endpoint "/products" está disponible,</p><p>Cuando se intenta crear un nuevo producto para un usuario que ya registró este producto,</p><p>Entonces se recibe una respuesta con estado 400,</p><p>Y se muestra un mensaje que indica "El usuario ya registró este producto".</p>|**EP07**|
|**TS16**|Delete Product|<p>` `**Como** usuario developer de la aplicación Cambiazo,</p><p>**Quiero** implementar una API que permita a los usuarios borrar sus productos,</p><p>**Para** que puedan eliminar los productos que subieron por error.</p>|<p>**Escenario 1: Eliminar un producto**</p><p>Dado que el endpoint "/products" está disponible,</p><p>Cuando se envía una solicitud DELETE con los detalles del producto y el usuario asociado,</p><p>Entonces se recibe una respuesta con estado 201,</p><p>Y se elimina el producto con su ID y los detalles registrados.</p>|**EP07**|
|**TS17**|Put Product|<p>**Como** usuario developer de la aplicación Cambiazo,</p><p>**Quiero** implementar una API que permita a los usuarios editar sus productos,</p><p>**Para** que puedan editar la información de los productos que subieron.</p>|<p>**Escenario 1: Editar un producto**</p><p>Dado que el endpoint "/products" está disponible,</p><p>Cuando se envía una solicitud PUT con los detalles del producto y el usuario asociado,</p><p>Entonces se recibe una respuesta con estado 201,</p><p>Y se editarán los detalles previamente registrados del producto.</p>|**EP07**|
...
Para lograr identificar y representar correctamente los usuarios y sistemas externos que se relacionan con nuestro sistema, hemos creado un diagrama de contexto, en el cual podemos ver que tenemos usuarios donadores, intercambiadores y administradores de la aplicación, y los sistemas externos son Gmail, el Sistema de Inicio de Sesión de Google, un Servicio de Pagos, y las ONG’s.
...
<div align="center">
    <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Class%20Diagram/class-diagram.jpeg?raw=true" width="800px" alt="class diagram">
</div><br><br>

Enlace: [Class Diagram en LucidChart](https://lucid.app/lucidchart/invitations/accept/inv_b3057c2c-0d68-4932-988f-920599058855)<br><br>
...
<div align="center">
    <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Database%20Diagram/database-diagram.jpeg?raw=true" width="800px" alt="database diagram">
</div><br>
...
<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Deployment-Landing/netlify1.jpg?raw=true" alt="netlify">
</div>
...
<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Deployment-Landing/netlify2.jpg?raw=true" alt="netlify">
</div>
...
<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Deployment-Landing/netlify3.jpg?raw=true" alt="netlify">
</div>
...
<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Deployment-Landing/netlify4.jpg?raw=true" alt="netlify">
</div>
...
<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Deployment-Landing/netlify5.jpg?raw=true" alt="netlify">
</div><br>


Elegimos Netlify debido a que su plataforma es muy fácil e intuitiva de utilizar, además de que podemos aprovechar en usar los repositorios que tengamos y de esta forma gestionar los avances y versiones de acuerdo al repositorio, para que luego los cambios se vean reflejado en la página.<br><br><br>
...
<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing1.png?raw=true" alt="landing-page" >
</div>
<br>


<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing2.png?raw=true" alt="landing-page" >
</div>
<br>


<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing3.png?raw=true" alt="characteristics-landing-page">
</div>
<br>


<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing4.png?raw=true" alt="characteristics-landing-page">
</div>
<br>


<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing5.png?raw=true" alt="gps-landing-page" >
</div>
<br>


<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing6.png?raw=true" alt="subscriptions-landing-page">
</div>
<br>


<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing7.png?raw=true" alt="team-landing-page" >
</div>
<br>


<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing8.png?raw=true" alt="contact-us-landing-page">
</div>
<br>


<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing9.png?raw=true" alt="contact-us-landing-page">
</div>
<br>
...
<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Landing-Page/landing10.png?raw=true" alt="contact-us-landing-page">
</div>
<br>
...
#### 5.2.1.6. Services Documentation Evidence for Sprint Review.
  ...
  En el transcurso del Sprint 1, hemos conseguido tener avances importantes al momento de crear los repositorios de nuestro proyecto para guardar la Landing Page y las pruebas de aceptación (acceptance test), ya que, al tener estos puntos bien definidos desde el comienzo, nos facilitó la organización de ideas.
...
|**Repository**|**Branch**|**Commit Id**|**Commit Message**|**Commit Message Body**|**Commited On (Date)**|
| :-: | :-: | :-: | :-: | :-: | :-: |
|AndresVZ23/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-2|25744fc|Feat: Created Sprint 2 folder and US-22|In this part, we created the folder for the sprint 2 and we applied Gherkin to the US-22.|29/04/2024|
|HelloNerk/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-2|9db3413|Feat: Created US-23|I created the US-23 in Gherkin|29/04/2024|
|123-Mathias/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-2|2dcd50f|Feat: Create TS-07|In this part, we applied Gherkin to the TS-07.|29/04/2024|
|123-Mathias/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-2|87f4d2c|Feat: Create TS-09|In this part, we applied Gherkin to the TS-09.|29/04/2024|
|diegooo01/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-2|b8eb664|Feat: Create US-24|I created the US-24 in Gherkin|29/04/2024|
|AndresVZ23/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-2|a6a08e5|Feat: Create TS-10|In this part, we applied Gherkin to the TS-10.|29/04/2024|
...
<b>Analíticos de GitHUb</b>
  ...
  + Web Application
          <div align="center">
        <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Sprint-3-Images/insights-front.PNG?raw=true" alt="contributor-evidence.">
        </div>
  + Backend
          <div align="center">
...
<div align="center">
  <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Sprint-4-Images/Sprint-Backlog-4.PNG?raw=true" alt="sprint">
</div><br><br>
...
|**Repository**|**Branch**|**Commit Id**|**Commit Message**|**Commit Message Body**|**Commited On (Date)**|
| :-: | :-: | :-: | :-: | :-: | :-: |
|AndresVZ23/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-4|21ef124|Feat: Create TS-01|In this part, we applied Gherkin to the TS-01|24/06/2024|
|diegooo01/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-4|ef23702|Feat: Create TS-02|In this part, we applied Gherkin to the TS-02|24/06/2024|
|IanHD04/TechZoOrganization-OpenSource/Acceptance-Test-OpenSource|feature/sprint-4|b09cb1d|Feat: Create TS-03|In this part, we applied Gherkin to the TS-03|24/06/2024|
...
## Validation Interviews
  ...
  <div align="center">
    <img src="https://github.com/TechZoOrganization-OpenSource/upc-pre-202401-si729-SW54-techzo-report/blob/main/Resources/Validation-Interviews/entrevista_validacion_rafaella.PNG?raw=true" alt="Validation Interviews">
 </div>


Enlace: [Validation](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210297_upc_edu_pe/EZm2N0rwpAZIv79W7hULIzIBjIm3CGTehZ5DSK44_u5T9Q?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=qwQWeY)
...
Enlace: [About The Team](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210297_upc_edu_pe/ERMc8wECDVpAp-bqqXfh3LABb59aClFXcKU9tML4jItxgQ?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=vJecZa)
